...
best_iteration = which.min(xgbcv$evaluation_log$test_mlogloss_mean)
...
write.csv(predictions, file="./data/XGBoost_no_mlr_first_last_last2.csv", quote=TRUE, row.names=FALSE)
