...
train_data_dense = subset(data_train_merged, !(total_events == 2))
...
write.csv(predictions, file="./data/XGBoost_no_mlr_first_first2_last_not_train_1.csv", quote=TRUE, row.names=FALSE)
