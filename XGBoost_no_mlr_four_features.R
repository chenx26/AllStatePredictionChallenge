...
data_train[, third_max_timestamp_by_policy:=sort(timestamp,partial=length(timestamp)-2)[length(timestamp)-2], by=id]
data_train[, second_min_timestamp_by_policy:=sort(timestamp,partial=2)[2], by=id]
...
data_train_last_element$second_min_timestamp_by_policy = NULL
...
data_train_first_element$second_min_timestamp_by_policy = NULL
setnames(data_train_first_element, "event", "first_event")

data_train_second_element = subset(data_train, timestamp==min_timestamp_by_policy)
data_train_second_element$timestamp = NULL
data_train_second_element$dummy_counter = NULL
data_train_second_element$max_timestamp_by_policy = NULL
data_train_second_element$second_max_timestamp_by_policy = NULL
data_train_second_element$third_max_timestamp_by_policy = NULL
data_train_second_element$min_timestamp_by_policy = NULL
data_train_second_element$second_min_timestamp_by_policy = NULL
setnames(data_train_second_element, "event", "second_event")
...
data_train_second_last_element$second_min_timestamp_by_policy = NULL
...
data_train_third_last_element$second_min_timestamp_by_policy = NULL
...
data_train_ohe <- merge(data_train_ohe, data_train_second_element, by=c("id"))
...
data_train_ohe$second_event <- factor(data_train_ohe$second_event, levels = unique_events)
...
data_test[, third_max_timestamp_by_policy:=sort(timestamp,partial=length(timestamp)-1)[length(timestamp)-1], by=id]
data_test[, second_min_timestamp_by_policy:=sort(timestamp,partial=2)[2], by=id]
...
data_test_first_event$second_min_timestamp_by_policy = NULL
setnames(data_test_first_event, "event", "first_event")

data_test_second_event = subset(data_test, timestamp==second_min_timestamp_by_policy)
data_test_second_event$timestamp = NULL
data_test_second_event$dummy_counter = NULL
data_test_second_event$second_max_timestamp_by_policy = NULL
data_test_second_event$third_max_timestamp_by_policy = NULL
data_test_second_event$min_timestamp_by_policy = NULL
data_test_second_event$second_min_timestamp_by_policy = NULL
setnames(data_test_second_event, "event", "second_event")
...
data_test_second_last_event$second_min_timestamp_by_policy = NULL
...
data_test_third_last_event$second_min_timestamp_by_policy = NULL
...
data_test_ohe <- merge(data_test_ohe, data_test_seond_event, by=c("id"))
...
data_test_ohe$second_event <- factor(data_test_ohe$second_event, levels = unique_events)
...
write.csv(predictions, file="./data/XGBoost_no_mlr_four_features.csv", quote=TRUE, row.names=FALSE)
