...
data_train[, min_timestamp_by_policy:=sort(timestamp,partial=length(timestamp)-1)[length(timestamp)-1], by=id]
...
write.csv(predictions, file="./data/XGBoost_mlr_lastevent.csv", quote=TRUE, row.names=FALSE)
